...
Record that exact id, never a session id from any inherited host variable.
Conductors obtain child ids from `subagent.spawn`
...
scrub host CLI nesting/session markers, preserving reviewer-home selection.
