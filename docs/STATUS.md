...
- Claude F2: explicit rationale, not scanner expansion. The human task expressly requested reviews/reviewer inflections; enumeration preserves the bounded quoted-H2 scanner rather than promising general English morphology. This deliberately does not reject every synonym or derivative such as `Reviewers notes`/`Reviewing report`.
