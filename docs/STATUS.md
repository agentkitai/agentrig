...
Active row: **R8a stable ACP v1 stdio**, implemented pending verification/review/final CI.
...
R9b PR #180 merged as `5344291`; post-main CI `34044946044` passed.
R7c PR #182 merged as `b2390ce`; post-main CI `34045706663` passed all three platforms.
...
### R7c done — PR #182, post-main CI green — bounded receipts, existing ingestion, actual startup banner

Final closeout: merged `b2390ce`; post-main CI `34045706663` passed Linux, macOS
and Windows. The following implementation-stage receipts retain their chronology.
...
### R9b done — PR #180; post-main CI 34044946044 green

Final closeout: merged `5344291`; post-main CI `34044946044` passed all three
platforms. Earlier pending-gate statements below are historical receipts.
