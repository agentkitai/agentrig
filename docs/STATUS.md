...
Active row: **R15d bounded remote MCP**, from green R15b main `74c5073`, integrated through `6322139`.
...
Integrated build/typecheck and Docker full suite pass: 2,825 plus two existing skips /172 files.
Actual nightly X1 PASS/FAIL and X4 human-pending BLOCKED controls pass; all four PR gates
remain. [Contract and limits](plans/R15d.md).
