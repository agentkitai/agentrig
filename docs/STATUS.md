...
the same full suite; it did not rerun build/typecheck. Current-main integration
and exact-head/post-main gates remain pending.
...
### R15h in progress — local agent roles
