...
queues and literal reference UI. Fifteen HTTP/WS/actual runtime controls and one
real Chromium task/permission/question/cancel/XSS smoke pass. Named bearer, Origin
and queued-output mutations are caught and restored. One review/full gates follow.
