...
Active row: **R15e on-demand diff review**, from green R9c main `3b7564a`, integrating ACP main `0493b09`.
R15e is independent of ACP and reuses delivered M6/permission foundations; it proceeds
while R15a waits for R8a, without claiming partial R15a/R15c delivery. R15b PR185 is done; all four exact post-main checks are green. R8a PR184 is
merged; its post-main gates are pending. R9c PR183 is done: all four post-main
...
[Contract and boundaries](plans/R15e.md). The single bounded review and material fixes are complete; final ACP-integrated validation follows.

### R8a merged — PR #184; post-main gates pending
...
were fixed with failing-before/passing-after controls. Final hosted gates remain.
