...
Active row: **R8a stable ACP v1 stdio**, implemented and reviewed; final combined gates pending.
...
R15b PR #185 merged as `74c5073`; post-main gates pending.
...
### R15b merged — PR #185; post-main gates pending
