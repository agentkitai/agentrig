...
One independent review and its material fix are complete; post-fix build/typecheck
and full Docker pass 2,889 plus two skips. Integrated-head and CI gates remain.
...
Main `b3bb06a` passed all four post-main checks: CI `34060311037` and scripted
structure `34060311027`. Earlier implementation-stage receipts follow unchanged.
