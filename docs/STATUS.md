...
Active row: **R16f truthful status line**, after completed R15i #202; independent from R15j provider switching and R16g maintenance. [Contract](plans/R16f.md).
...
R16d prompt history/completion is done (PR #200); R16a has a separate owner/PR; R16c is done (PR #198); R8d is done (PR #197). R15h is done (PR #196), main `31193d6`, all
...
Main `93452df95a731a38bd46badb78953d13a7c8f272` passed all four post-main
checks: CI `34073899219`, structure `34073899121`.
