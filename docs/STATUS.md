...
Active row: **R15d bounded remote MCP**, from green R15b main `74c5073`, integrated through `eead687`.
...
provider/storage/resume/summary controls are implemented; full verification and one
independent review remain. [Contract and limits](plans/R15d.md).
