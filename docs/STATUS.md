...
Active row: **R8d authenticated reference web client**, implementation and verification in progress. R8c is done (PR #192, all four post-main checks green). R15a is done (PR #188 + repair #191); R15d is done (PR #189); R15f is done (PR #190); R15e is done (PR #186).
...
### R8d in progress — authenticated loopback ACP reference client
