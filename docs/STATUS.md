...
Active row: **R15a structured questions**, started from green ACP main `0493b09`, integrating review main `eead687`.
...
Four negative mutations were detected and restored. Full suite and the single
independent review remain pending; delivery is not yet claimed.

### R15e merged — PR #186; post-main checks pending
