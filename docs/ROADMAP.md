...
| 14 | R15h (in progress, independent of R15c/g) → R15i → R15j → R15k | Roles after R12d delegation; ledger before R7 unattended runs are enabled by default; TUI conveniences last. |
