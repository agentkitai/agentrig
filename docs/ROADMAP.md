...
| 10 | R7a (done, PR #176 + repair #178) → R7b → R7c | Bounded unattended execution using completed permission, lifecycle and reporting foundations. |
