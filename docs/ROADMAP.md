...
| 13 | R15d → R15e (done, PR #186) → R15f (in progress) → R15g | Interop and headless shapes; R15d follows R11a (`net` class) and R5d; R15f follows R12c (grant inspection) so the CI posture is auditable. |
