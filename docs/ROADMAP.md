...
Final implementation: **R16h themes/keybindings**. R16g is done in PR#210 on
...
| Implemented; final R16h delivery gates | R16: TUI polish within the Static-scrollback model | Section 5 orders R16 after R15's first group; the alternate-screen renunciation stays |
