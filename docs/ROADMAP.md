...
| 12 | R15b (done, PR #185) → R15a (done, PR #188 + repair #191) → R15c (in progress) | Interaction and observation quality; independent of each other, may run in parallel after R12d and R13c merge. |
