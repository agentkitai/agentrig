...
| 12 | R15b (done, PR #185) → R15a (merged #188; post-main repair active) → R15c | Interaction and observation quality; independent of each other, may run in parallel after R12d and R13c merge. |
