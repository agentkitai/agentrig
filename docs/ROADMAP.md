...
| 13 | R15d (done, PR #189) / R15e (done, PR #186) → R15f (in progress) → R15g | Independent interop and review lanes; R15d follows completed R11a (`net` class) and R5d; R15f follows R12c (grant inspection) so the CI posture is auditable. |
