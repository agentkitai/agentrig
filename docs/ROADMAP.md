...
|---|---|---|---|
| Structured clarifying question from the model (`ask_user`) | Claude Code, Codex, Cline, Goose | free text only; the supervisor talks to the model, the model has no channel back | R15a *(in progress; [contract](plans/R15a.md))* |
...
| 12 | R15b (done, PR #185) → R15a (in progress, ACP delivered) → R15c | Interaction and observation quality; independent of each other, may run in parallel after R12d and R13c merge. |
