...
| Reasoning/thinking blocks preserved across turns | Anthropic interleaved thinking, OpenAI reasoning items | Persisted replay, safe display/export and compaction delivered in PR #193; all four post-main checks green | R15c *(done, PR #193; [contract](plans/R15c.md))* |
