...
| 11 | R8a (done, PR #184) → R8b (done, PR #187) → R8c (done, PR #192) → R8d (in progress) | Reusable control transport on the editor standard, MCP serving, telemetry, then an authenticated local web client. |
