...
| R9c *(implemented; review/CI gates pending; [contract](plans/R9c.md))* | Nightly structure-regression job using the E1 eval-set definition and E2 reports, driven by a scripted provider. This validates mechanics, not task success or model quality; preserve E3's separate live evaluation lane | docs + .github |
...
| 9 | R9a (done, PR #175) → R9b (done, PR #180) → R9c (implementation/review gates) | Redacted export and evaluation interfaces over E, not a second evaluation engine. |
