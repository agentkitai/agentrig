...
| 14 | R15h (done, PR #196) → R15i (in progress) → R15j → R15k | Roles after R12d delegation; ledger before R7 unattended runs are enabled by default; TUI conveniences last. |
| 15 | R15l | Decision recorded after R10c; no build until then. |
| 16 | R16a → R16b → R16c (done, PR #198) → R16d → R16e → R16f → R16g → R16h | TUI polish after R15's first group: R16b uses R12b effect lines, R16e waits for R15a, R16f uses R15i when present. R16a/c/d are independent and may run in parallel. |
