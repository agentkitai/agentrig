...
| Claude LOW 6 — smoke helper reference | Replace the .agentrig/r17/recommended-smoke.py reference with docs/plans/R17b-repair-smoke.py and link this reproducible round-3 receipt. Outside-train #259 correction: the former helper was tracked (added in ebc2a6e), not nonexistent; this is a reference/provenance correction. |
