...
await writeFile(process.env.AGENTRIG_REPAIR_RECEIPT ?? join(root,'docs/plans/R17b-repair-e1.json'),JSON.stringify(results.map(({check,...row})=>({...row,check:{outcome:check.outcome,behavior:check.behavior}})),null,2)+'\n');
